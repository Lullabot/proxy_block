    ...
    ha ||
      ...
      (function (Et, zt) {
        (function (C, De) {
          ...
          const De = navigator.platform;
          const I = /gecko\/\d/i.test(C);
          const K = /MSIE \d/.test(C);
          const $ = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(C);
          const V = /Edge\/(\d+)/.exec(C);
          const b = K || $ || V;
          const N = b && (K ? document.documentMode || 6 : +(V || $)[1]);
          let _ = !V && /WebKit\//.test(C);
          const ie = _ && /Qt\/\d+\.\d+/.test(C);
          const O = !V && /Chrome\/(\d+)/.exec(C);
          const q = O && +O[1];
          let z = /Opera\//.test(C);
          const X = /Apple Computer/.test(navigator.vendor);
          const ke = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(C);
          const we = /PhantomJS/.test(C);
          const te =
            X && (/Mobile\/\w+/.test(C) || navigator.maxTouchPoints > 2);
          const re = /Android/.test(C);
          const ne =
            te ||
            re ||
            /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(C);
          const se = te || /Mac/.test(De);
          const Ae = /\bCrOS\b/.test(C);
          const ye = /win/i.test(De);
          let de = z && C.match(/Version\/(\d*\.\d*)/);
          ...
          const Ve = { scroll: !1 };
          const ct = { origin: '*mouse' };
          const Oe = { origin: '+move' };
          function Re(e, t, n) {
            for (let r = 0, i = 0; ; ) {
              let o = e.indexOf('	', r);
              o == -1 && (o = e.length);
          ...
          function Nt(e, t, n) {
            for (let r = t > n ? -1 : 1; ; ) {
              if (t == n) return t;
              const i = (t + n) / 2;
              const o = r < 0 ? Math.ceil(i) : Math.floor(i);
          ...
          function sr(e) {
            ...
            const n = w(t, 0, 1).getBoundingClientRect();
            const r = w(t, 1, 2).getBoundingClientRect();
            return (
              D(e),
...
`,
          ...
          function xi(e) {
            ...
            const r = w(t, 0, 1).getBoundingClientRect();
          ...
          function fn(e, t, n) {
            ...
            const o = Ha(e, t, n);
            const l = o > r.first && ce(r, o - 1).stateAfter;
            const a = l ? Xt.fromSaved(r, l, o) : new Xt(r, Wr(r.mode), o);
            return (
          ...
          function bi(e, t, n, r) {
            const i = e.doc.mode;
            const o = new Je(t, e.options.tabSize, n);
            for (
          ...
          function bo(e, t, n, r) {
            ...
            t = Ce(i, t);
            const a = ce(i, t.line);
            const s = fn(e, t.line, n);
            const u = new Je(a.text, e.options.tabSize, s);
            let h;
          ...
          function wo(e, t, n, r, i, o, l) {
            ...
            let s = 0;
            let u = null;
            const h = new Je(t, e.options.tabSize, r);
            let v;
            const k = e.options.addModeClass && [null];
          ...
          function wi(e, t) {
            ...
            const r = A(e, t.to.line) && ce(e, t.to.line).markedSpans;
            if (!n && !r) return null;
            const i = t.from.ch;
            const o = t.to.ch;
            const l = Z(t.from, t.to) == 0;
            let a = Ga(n, i, l);
            let s = Xa(r, o, l);
            const u = t.text.length == 1;
            const h = ge(t.text).length + (u ? i : 0);
            if (a)
          ...
          function Si(e, t) {
            ...
            const r = e.find();
            const i = t.find();
            const o = Z(r.from, i.from) || qn(e) - qn(t);
            if (o) return -o;
            const l = Z(r.to, i.to) || jn(e) - jn(t);
            return l || t.id - e.id;
          }
          function Do(e, t) {
            const n = $t && e.markedSpans;
            let r;
            if (n)
          ...
          function Fo(e, t, n, r, i) {
            const o = ce(e, t);
            const l = $t && o.markedSpans;
            if (l)
              for (let a = 0; a < l.length; ++a) {
                const s = l[a];
                if (s.marker.collapsed) {
                  const u = s.marker.find(0);
                  const h = Z(u.from, n) || qn(s.marker) - qn(i);
                  const v = Z(u.to, r) || jn(s.marker) - jn(i);
                  if (
                    !((h >= 0 && v <= 0) || (h <= 0 && v >= 0)) &&
                    ((h <= 0 &&
          ...
          function ns(e, t, n, r, i, o, l) {
            if (t) {
              const a = e.splitSpaces ? is(t, e.trailingSpace) : t;
              const s = e.cm.state.specialChars;
              let u = !1;
              let h;
              if (!s.test(t))
                ((e.col += t.length),
                ...
                for (let v = 0; ; ) {
                  s.lastIndex = v;
                  const k = s.exec(t);
                  const x = k ? k.index - v : t.length - v;
                  if (x) {
...
`
              ...
              if (x == s) {
                ...
                if (ee)
                  for (let st = 0; st < ee.length; st += 2)
                    ee[st + 1] == x && (E += ` ${ee[st]}`);
                if (!U || U.from == s)
                  for (let Xe = 0; Xe < G.length; ++Xe) Oo(t, 0, G[Xe]);
                if (U && (U.from || 0) == s) {
                  if (
                    (Oo(
                      t,
          ...
          function Bo(e, t, n, r) {
            if (
              ...
              ((t.gutterBackground = d(
                ...
                }px; width: ${r.gutterTotalWidth}px`,
              )),
            ...
            if (e.options.lineNumbers || o) {
              ...
              if (
                ...
                e.options.lineNumbers &&
                  ...
                  (t.lineNumber = a.appendChild(
                    d(
                      ...
                      }px; width: ${e.display.lineNumInnerWidth}px`,
                    ),
                  )),
                o)
              )
                for (let s = 0; s < e.display.gutterSpecs.length; ++s) {
                  ...
                  const h = o.hasOwnProperty(u) && o[u];
                  h &&
                    a.appendChild(
                      d(
                        'div',
          ...
          function ms(e, t) {
            t = qt(t);
            const n = f(t);
            const r = (e.display.externalMeasured = new Po(e.doc, t, n));
            r.lineN = n;
          ...
          function ys(e, t) {
            let n = jo;
            if (t == 'left')
              for (let r = 0; r < e.length && (n = e[r]).left == n.right; r++);
            else
              for (
                let i = e.length - 1;
          ...
          function Ei(e) {
            ...
            let r = 0;
            if (n)
              for (let i = 0; i < n.length; ++i) n[i].above && (r += pn(n[i]));
            return r;
          }
          ...
          function Kr(e) {
            ...
            const n = d('pre', [t], 'CodeMirror-line-like');
            J(e.measure, n);
          ...
          function Tr(e, t, n, r) {
            ...
            let o;
            let l;
            const a = i.lineSpace.getBoundingClientRect();
            try {
          ...
          function tl(e, t) {
            ...
            const o = (r.selection = document.createDocumentFragment());
          ...
          function Wi(e, t, n) {
            ...
            const i = n.appendChild(d('div', ' ', 'CodeMirror-cursor'));
            if (
          ...
          function Ls(e, t, n) {
            ...
            const l = Ho(e.display);
            const a = l.left;
            const s =
              Math.max(r.sizerWidth, wr(e) - r.sizer.offsetLeft) - l.right;
            const u = i.direction == 'ltr';
            ...
            function v(G, ee, me) {
              ...
              function Mt(tt, St, ft) {
                ...
                const rt = (St == 'ltr') == (ft == 'after') ? 'left' : 'right';
                const Qe =
                  ft == 'after'
                    ? nt.begin
              ...
              return (
                or(wt, ee || 0, me ?? Fe, function (tt, St, ft, nt) {
                  const rt = ft == 'ltr';
                  const Qe = Xe(tt, rt ? 'left' : 'right');
                  const Tt = Xe(St - 1, rt ? 'right' : 'left');
                  const nn = ee == null && tt == 0;
                  const xr = me == null && St == Fe;
                  const gt = nt == 0;
                  const Jt = !wt || nt == wt.length - 1;
                  if (Tt.top - Qe.top <= 3) {
                    const ut = (u ? nn : xr) && gt;
                    const co = (u ? xr : nn) && Jt;
                    const ir = ut ? a : (rt ? Qe : Tt).left;
                    const Ar = co ? s : (rt ? Tt : Qe).right;
            ...
            if (k.line == x.line) v(k.line, k.ch, x.ch);
              ...
              const E = ce(i, x.line);
              const R = qt(M) == qt(E);
              const U = v(k.line, k.ch, R ? M.text.length + 1 : null).end;
              const Q = v(x.line, R ? 0 : null, x.ch).start;
              (R &&
                (U.top < Q.top - 2
          ...
          function Vn(e) {
            for (
              ...
              const a = t.view[l];
              const s = e.options.lineWrapping;
              let u = void 0;
              let h = 0;
              if (!a.hidden) {
                ...
                if (
                  ...
                  for (let M = 0; M < a.rest.length; M++) nl(a.rest[M]);
          ...
          function Cs(e, t) {
            if (!Ze(e, 'scrollCursorIntoView')) {
              ...
              let i = null;
              const o = n.wrapper.ownerDocument;
              if (
                (t.top + r.top < 0
                  ? (i = !0)
                  : t.bottom + r.top >
          ...
          function Ds(e, t, n, r) {
            ...
            for (let o = 0; o < 5; o++) {
              ...
              const u = qi(e, i);
              const h = e.doc.scrollTop;
              const v = e.doc.scrollLeft;
              if (
                (u.scrollTop != null &&
                  (yn(e, u.scrollTop),
          ...
          function qi(e, t) {
            ...
            const x = wr(e) - n.gutters.offsetWidth;
            const M = t.right - t.left > x;
            return (
              M && (t.right = t.left + x),
              t.left < 10
                ? (l.scrollLeft = 0)
          ...
          function xn(e) {
            ...
            const r = Math.round(e.doc.height + Mi(e.display));
            return {
          ...
          function Es(e) {
            ...
            for (let r = 0; r < t.length; r++) Os(t[r]);
            for (let i = 0; i < t.length; i++) Ps(t[i]);
            for (let o = 0; o < t.length; o++) Is(t[o]);
            for (let l = 0; l < t.length; l++) zs(t[l]);
          }
          function Ns(e) {
            const t = e.cm;
            const n = t.display;
          ...
          function Bs(e) {
            ...
            if (!(t.highlightFrontier >= e.display.viewTo)) {
              ...
              const r = fn(e, t.highlightFrontier);
              const i = [];
              (t.iter(
                r.line,
          ...
          function cl(e) {
            ...
            const t = e.doc;
            const n = W(e.options, t.first + t.size - 1);
            const r = e.display;
            if (n.length != r.lineNumChars) {
              ...
              const o = i.firstChild.offsetWidth;
              const l = i.offsetWidth - o;
              return (
          ...
          function dl(e) {
            ...
            for (let r = 0; r < n.length; ++r) {
              ...
              const o = i.className;
              const l = i.style;
              const a = t.appendChild(d('div', null, `CodeMirror-gutter ${o}`));
              (l && (a.style.cssText = l),
                o == 'CodeMirror-linenumbers' &&
                  ((e.lineGutter = a),
          ...
          function pl(e, t) {
            ...
            const l = e.display;
            const a = l.scroller;
            const s = a.scrollWidth > a.clientWidth;
            ...
            if ((r && s) || (i && u)) {
              ...
              if (i && o != null) {
                const x = i * o;
                let M = e.doc.scrollTop;
                let E = M + l.wrapper.clientHeight;
                (x < 0
                  ? (M = Math.max(0, M + x - 50))
                  ...
                  ? ((l.wheelStartX = a.scrollLeft),
                    ...
                    setTimeout(function () {
                      if (l.wheelStartX != null) {
                        ...
                        const U = a.scrollTop - l.wheelStartY;
                        const Q =
          ...
          function Kt(e, t, n) {
            ...
            for (let o = 1; o < t.length; o++) {
              const l = t[o];
              const a = t[o - 1];
              const s = Z(a.to(), l.from());
              if (r && !l.empty() ? s > 0 : s >= 0) {
                const u = _r(a.from(), l.from());
                const h = xt(a.to(), l.to());
                const v = a.empty() ? l.from() == l.head : a.from() == a.head;
          ...
          function Ks(e, t, n) {
            for (
              ...
              const a = t[l];
              const s = vl(a.from, i, o);
              const u = vl(gr(a), i, o);
              if (((i = a.to), (o = u), n == 'around')) {
                const h = e.sel.ranges[l];
                const v = Z(h.head, h.anchor) < 0;
          ...
          function Qi(e, t, n, r) {
            ...
            const v = ce(e, s.line);
            const k = ge(u);
            const x = i(u.length - 1);
            const M = s.line - a.line;
            if (t.full)
          ...
          function Fl(e, t, n, r) {
            for (var i, o = 0; o < t.ranges.length; o++) {
              const l = t.ranges[o];
              const a =
                t.ranges.length == e.sel.ranges.length && e.sel.ranges[o];
              const s = ai(e, l.anchor, a && a.anchor, n, r);
              const u =
                l.head == l.anchor ? s : ai(e, l.head, a && a.head, n, r);
          ...
          function Zr(e, t, n, r, i) {
            ...
            if (o.markedSpans)
              for (let l = 0; l < o.markedSpans.length; ++l) {
                ...
                const s = a.marker;
                const u = 'selectLeft' in s ? !s.selectLeft : s.inclusiveLeft;
                const h =
          ...
          function eu(e, t, n, r, i) {
            ((r = Te(r)), (r.shared = !1));
            const o = [Vr(e, t, n, r, i)];
            let l = o[0];
            const a = r.widgetNode;
            return (
              vr(e, function (s) {
          ...
          ((kt.prototype = F(Dn.prototype, {
            ...
            findMarksAt(e) {
              e = Ce(this, e);
              const t = [];
              const n = ce(this, e.line).markedSpans;
              if (n)
                for (let r = 0; r < n.length; ++r) {
                  const i = n[r];
...
`
          ...
          for (let ui = 65; ui <= 90; ui++) yr[ui] = String.fromCharCode(ui);
          ...
          function no(e, t, n, r, i) {
            if (e) {
              ...
              if (o) {
                const l = i < 0 ? ge(o) : o[0];
                const a = i < 0 == (l.level == 1);
                const s = a ? 'after' : 'before';
                let u;
          ...
          function du(e, t, n, r) {
            ...
            const h = u(n.sticky == 'before' ? a(n, -1) : n.ch);
            ...
            const M = function (U, Q, G) {
              for (
                let ee = function (Ke, st) {
                  return st
                ...
                const me = i[U];
                const pe = Q > 0 == (me.level != 1);
                let Fe = pe ? G.begin : a(G.end, -1);
                if (
                  (me.from <= Fe && Fe < me.to) ||
          ...
          const Nn = {
            ...
            insertSoftTab(e) {
              for (
                ...
                const o = n[i].from();
                const l = Le(e.getLine(o.line), o.ch, r);
                t.push(et(r - (l % r)));
              }
...
`,
          ...
          function Zl(e, t) {
            const n = Yl(e, t.line);
            const r = ce(e.doc, n.line);
            const i = We(r, e.doc.direction);
            if (!i || i[0].level == 0) {
              const o = Math.max(n.ch, r.text.search(/\S/));
              const l = t.line == n.line && t.ch <= o && t.ch;
          ...
          function Tu(e, t, n, r) {
            ...
            const x = i.wrapper.getBoundingClientRect();
            let M = 0;
            function E(G) {
              const ee = ++M;
              const me = Tr(e, G, !0, r.unit == 'rectangle');
              if (me)
                if (Z(me, v) != 0) {
          ...
          function Lu(e, t) {
            ...
            if (r.line != n.line)
              ...
              const v = h - l || (r.ch - n.ch) * (a.level == 1 ? -1 : 1);
              h == s - 1 || h == s ? (u = v < 0) : (u = v > 0);
            }
            const k = o[s + (u ? -1 : 0)];
            const x = u == (k.level == 1);
            const M = x ? k.from : k.to;
            const E = x ? 'after' : 'before';
          ...
          function na(e, t, n, r) {
            ...
            r && ht(t);
            const l = e.display;
            const a = l.lineDiv.getBoundingClientRect();
            ...
            for (let s = 0; s < e.display.gutterSpecs.length; ++s) {
              ...
              if (u && u.getBoundingClientRect().right >= i) {
                const h = g(e.doc, o);
                const v = e.display.gutterSpecs[s];
          ...
          function Ge(e, t) {
            ...
            const o = (this.display = new qs(e, r, i, t));
            ...
            (ve(t.scroller, 'touchstart', function (s) {
              ...
              ve(t.scroller, 'touchend', function (s) {
                ...
                if (
                  ...
                  const h = e.coordsChar(t.activeTouch, 'page');
                  let v;
                  (!u.prev || l(u, u.prev)
                    ? (v = new He(h, h))
          ...
          function zn(e, t, n, r) {
            ...
            const a = ce(i, t);
            const s = Le(a.text, null, l);
            a.stateAfter && (a.stateAfter = null);
            const u = a.text.match(/^\s*/)[0];
            let h;
            ...
            if (e.options.indentWithTabs)
              for (let x = Math.floor(h / l); x; --x) ((k += l), (v += '	'));
            if ((k < h && (v += et(h - k)), v != u))
              return (
          ...
          function so(e, t, n, r, i) {
            ...
            const a = i == 'paste' || e.state.pasteIncoming > l;
            const s = Pt(t);
            let u = null;
...
`) &&
          ...
          function ua(e) {
            for (var t = [], n = [], r = 0; r < e.doc.sel.ranges.length; r++) {
              ...
              const o = { anchor: L(i, 0), head: L(i + 1, 0) };
          ...
          function Eu(e) {
            ...
            ((e.prototype = {
              ...
              getTokenTypeAt(r) {
                r = Ce(this.doc, r);
                const i = mo(this, ce(this.doc, r.line));
                let o = 0;
                let l = (i.length - 1) / 2;
                const a = r.ch;
                let s;
              ...
              moveV: vt(function (r, i) {
                ...
                const a = [];
                const s =
                  !this.display.shift && !l.extend && l.sel.somethingSelected();
                if (
...
`
          ...
          function ca(e, t, n, r) {
            ...
            if (r == 'page') {
              ...
              const s = Math.max(a - 0.5 * jr(e.display), 3);
...
`)));
            ...
            (je.prototype.showPrimarySelection = function () {
              ...
              const l = pi(t, e.focusNode, e.focusOffset);
              if (
                !(
                  o &&
                  !o.bad &&
                ...
                const a = t.display.view;
                const s = (r.line >= t.display.viewFrom && da(t, r)) || {
                  node: a[0].measure.map[2],
                  offset: 0,
                };
                let u = i.line < t.display.viewTo && da(t, i);
                if (!u) {
                  const h = a[a.length - 1].measure;
                  const v = h.maps ? h.maps[h.maps.length - 1] : h.map;
                  u = {
                    node: v[v.length - 1],
                ...
                const k = e.rangeCount && e.getRangeAt(0);
                let x;
                try {
            ...
            (je.prototype.pollSelection = function () {
              if (
                ...
                if (!this.composing) {
                  ...
                  const r = pi(t, e.focusNode, e.focusOffset);
                  n &&
                    r &&
                    Dt(t, function () {
                      (pt(t.doc, pr(n, r), Ve),
            ...
            (je.prototype.pollContent = function () {
              ...
              const me = L(l, x);
              const pe = L(u, k.length ? ge(k).length - M : 0);
          ...
          function da(e, t) {
            ...
            const r = ce(e.doc, t.line);
            const i = Ro(n, r, t.line);
            const o = We(r, e.doc.direction);
            let l = 'left';
            if (o) {
              const a = lr(o, t.ch);
              l = a % 2 ? 'right' : 'left';
          ...
          function Ou(e, t, n, r, i) {
            ...
            function k(x) {
              if (x.nodeType == 1) {
                ...
                const E = x.getAttribute('cm-marker');
                let R;
                if (E) {
            ...
            function h(R, U, Q) {
              for (let G = -1; G < (u ? u.length : 0); G++)
                for (
                  ...
                  const pe = ee[me + 2];
                  if (pe == R || pe == U) {
                    const Fe = f(G < 0 ? e.line : e.rest[G]);
                    let Ke = ee[me] + Q;
                    return (
...
`) > -1
            ...
            ($e.prototype.onContextMenu = function (e) {
              ...
              const u = t.wrapper.style.cssText;
              const h = t.wrapper.offsetParent.getBoundingClientRect();
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          C.defineMode('css', function (fe, H) {
            ...
            const D = fe.indentUnit;
            const J = H.tokenHooks;
            const d = H.documentTypes || {};
            const S = H.mediaTypes || {};
            const w = H.mediaFeatures || {};
            const m = H.mediaValueKeywords || {};
            const y = H.propertyKeywords || {};
            const P = H.nonStandardPropertyKeywords || {};
            const le = H.fontProperties || {};
            const p = H.counterDescriptors || {};
            const c = H.colorKeywords || {};
            const Y = H.valueKeywords || {};
            const xe = H.allowNested;
            const j = H.lineComment;
            const ue = H.supportsAtComponent === !0;
            const Te = fe.highlightNonStandardPropertyKeywords !== !1;
            let Le;
            let be;
            function oe(T, B) {
              return ((Le = B), T);
            ...
            function et(T, B, F, Ie) {
              for (let ae = Ie || 1; ae > 0; ae--) F.context = F.context.prev;
              return Ue(T, B, F);
            }
            function ge(T) {
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          (C.defineMode('javascript', function (De, I) {
            ...
            const $ = I.statementIndent;
            const V = I.jsonld;
            const b = I.json || V;
            const N = I.trackScope !== !1;
            const _ = I.typescript;
            const ie = I.wordCharacters || /[\w$\xa1-\uffff]/;
            const O = (function () {
              function f(it) {
            ...
            function S(f, g) {
              for (let A = g; A; A = A.next) if (A.name == f) return !0;
              return !1;
            }
            function w(f) {
              const g = D.state;
        ...
        (function (C) {
          ...
          (C.defineMode('python', function (N, _) {
            for (
              ...
              q[z] || q.splice(z--, 1);
            const X = _.hangingIndent || N.indentUnit;
            let ke = K;
            let we = $;
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          C.defineMode('clike', function (m, y) {
            const P = m.indentUnit;
            const le = y.statementIndentUnit || P;
            const p = y.dontAlignCalls;
            const c = y.keywords || {};
            const Y = y.types || {};
            const xe = y.builtin || {};
            const j = y.blockKeywords || {};
            const ue = y.defKeywords || {};
            const Te = y.atoms || {};
            const Le = y.hooks || {};
            const be = y.multiLineStrings;
            const oe = y.indentStatements !== !1;
            const Ne = y.indentSwitch !== !1;
            const qe = y.namespaceSeparator;
            const Ve = y.isPunctuationChar || /[\[\]{}\(\),;\:\.]/;
            const ct = y.numberStart || /[\d\.]/;
            const Oe =
              y.number ||
              /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i;
            const Re = y.isOperatorChar || /[+\-*&%=<>!?|\/]/;
            const Ue = y.isIdentifierChar || /[\w\$_\xa1-\uffff]/;
            const et = y.isReservedIdentifier || !1;
            let ge;
            let Pe;
            function T(ae, Se) {
              const he = ae.next();
          ...
          const X = b('SEL instancetype id Class Protocol BOOL');
          function ke(m) {
          ...
          function Ee(m, y) {
            ...
            const P = [];
            function le(c) {
              if (c) for (const Y in c) c.hasOwnProperty(Y) && P.push(Y);
            }
            (le(y.keywords),
              le(y.types),
              le(y.builtin),
            ...
            for (let p = 0; p < m.length; ++p) C.defineMIME(m[p], y);
          }
        ...
        (function (C) {
          ...
          ((C.findModeByMIME = function (K) {
            ...
            (C.findModeByFileName = function (K) {
              ...
              const N = b > -1 && K.substring(b + 1, K.length);
        ...
        (function (C) {
          ...
          (C.defineMode(
            ...
            function (De, I) {
              ...
              const ie = /^(?:[*\-+]|^[0-9]+([.)]))\s+/;
              const O = /^\[(x| )\](?=\s)/i;
              const q = I.allowAtxHeaderWithoutSpace ? /^(#+)/ : /^(#+)(?: |$)/;
              const z = /^ {0,3}(?:\={1,}|-{2,})\s*$/;
              const X = /^[^#!\[\]*_\\<>` "'(~:]+/;
              const ke = /^(~~~+|```+)[ \t]*([\w\/+#-]*)[^\n`]*$/;
              const we = /^\s*\[[^\]]+?\]:.*$/;
              ...
              function de(p, c) {
                ...
                const xe = Ae(c.prevLine.stream);
                const j = c.indentedCode;
                const ue = c.prevLine.hr;
                const Te = c.list !== !1;
                const Le = (c.listStack[c.listStack.length - 1] || 0) + 3;
                c.indentedCode = !1;
              ...
              function fe(p, c) {
                const Y = c.listStack[c.listStack.length - 1] || 0;
                const xe = c.indentation < Y;
                const j = Y + 3;
                if (
                  c.fencedEndRE &&
                  c.indentation <= j &&
        ...
        (function (C) {
          ...
          ((C.defineSimpleMode = function (O, q) {
            ...
            (C.simpleMode = function (O, q) {
              ...
              if (X)
                for (const ye in X) X.hasOwnProperty(ye) && (Ae[ye] = X[ye]);
              return Ae;
            }));
          function De(O, q) {
          ...
          function V(O, q) {
            return function (z, X) {
              ...
              for (let re = O[X.state], ne = 0; ne < re.length; ne++) {
                const se = re[ne];
                const Ae = (!se.data.sol || z.sol()) && z.match(se.regex);
                if (Ae) {
                  (se.data.next
          ...
          function N(O, q, z, X) {
            ...
            const re = ke ? ke.state : C.startState(te);
            (z.persistent &&
              !ke &&
              (q.persistentStates = {
                mode: te,
          ...
          function _(O, q) {
            for (let z = 0; z < q.length; z++) if (q[z] === O) return !0;
          }
          function ie(O, q) {
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          (C.defineMode('yaml', function () {
            ...
            const I = new RegExp(`\\b((${De.join(')|(')}))$`, 'i');
            return {
              token(K, $) {
                const V = K.peek();
                const b = $.escaped;
